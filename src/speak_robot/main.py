...
def check_thread(error_q, command_entry_q):
    if not error_q.empty():
        ...
        if thread_name == 'SYN7813':
            ...
            status_t = start_thread(receive_status, error_q, 'receive_status_Thread')
            ...
            status_t = start_thread(chart_d.online_chart_mode, (error_q, command_entry_q), 'online_chart_status_Thread')
...
try:
    ...
    #打开SYN7318返回处理线程
    reveive_status_t = start_thread(receive_status, error_q, 'receive_status_Thread')
    #打开 mp3 处理线程
